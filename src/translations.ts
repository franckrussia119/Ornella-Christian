...
export const translations: Record<Language, TranslationDict> = {
  en: {
    ...
    heroAnd: '&',
    heroLocation: 'Baham & Nkongsamba, Cameroon',
    heroDays: 'Days',
    heroHours: 'Hours',
    heroMins: 'Mins',
    heroSecs: 'Secs',
    ...
    storySubtitle: "De l'Ange & Joverlin",
    storyTitle: 'Our Love Story',
    storyHeadingDesc: 'The beautiful journey that led us from a chance meeting as students at the University of Buea to our lifetime commitment.',

    ceremonySubtitle: 'Join us in Celebration',
    ceremonyTitle: 'Wedding Ceremonies',
    ceremonyHeadingDesc: 'We are honored to celebrate our union across two beautiful Cameroonian regions: our cultural customary rites in Baham and our civil and religious wedding vows in Nkongsamba.',
    ...
    formLabelRelationship: "Relationship to De l'Ange & Joverlin",
    formLabelCardDesign: 'Select Card Design Background Theme',
    formLabelBlessing: 'Your Heartfelt Wedding Blessing / Prayer *',
    formPlaceholderBlessing: "Write your prayers, advice, or warm congratulations for De l'Ange and Joverlin as they step into this sacred union...",
    ...
    formSuccessDesc: "Thank you so much! Your beautiful wedding gift pledge and digital blessing card have been registered for De l'Ange & Joverlin.",
    ...
    faqHeadingDesc: 'Planning your trip to Baham and Nkongsamba? We have gathered all the essential guidelines for travel, attire, registry contributions, and ceremony expectations.',
    faqFlightTitle: 'Flights & Transit',
    faqFlightDesc: 'For both the Traditional Customary Wedding (Baham) and the Civil & Religious Wedding (Nkongsamba), fly into Douala International Airport (DLA) — the closest gateway to both venues.',
    faqFlightAirportCode: 'Airport Codes: NSI, DLA',
    faqHotelTitle: 'Hotel Partner Blocks',
    faqHotelDesc: 'We have arranged special blocked group pricing at select premium partner hotels near both Baham (Bafoussam/Bandjoun) and Nkongsamba.',
    ...
    rsvpHeadingDesc: 'Please let us know if you will celebrate with us by July 1st, 2026. Your timely response helps us arrange fine dining accommodations and seating coordinates in Baham and Nkongsamba.',
    rsvpVenueDotation: '{{Venue Name — to be confirmed}} • Baham, West Region, Cameroon',
    rsvpVenueWhite: '{{Church / Reception Venue — to be confirmed}}, Nkongsamba, Littoral Region, Cameroon',
    rsvpCoordinator: 'rsvp@christian-ornella.com • +237 6XX XX XX XX (WhatsApp)',
    rsvpRouteTitle: 'Baham to Nkongsamba Route',
    rsvpRouteDesc: 'Both celebrations are a week apart in different regions — guests attending both are welcome to travel between Baham and Nkongsamba via Douala at their own pace.',
    ...
    footerDesc: 'We are incredibly blessed to walk this beautiful journey of customary rites in Baham and civil & religious vows in Nkongsamba. Thank you for your endless prayers, support, and blessings on our household.',
  ...
  fr: {
    ...
    heroAnd: '&',
    heroLocation: 'Baham & Nkongsamba, Cameroun',
    heroDays: 'Jours',
    heroHours: 'Heures',
    heroMins: 'Min',
    heroSecs: 'Sec',
    ...
    storyHeadingDesc: "Le magnifique voyage qui nous a menés d'une rencontre fortuite à l'Université de Buea jusqu'à notre engagement pour la vie.",

    ceremonySubtitle: 'Rejoignez-nous pour Célébrer',
    ceremonyTitle: 'Cérémonies de Mariage',
    ceremonyHeadingDesc: 'Nous sommes honorés de célébrer notre union à travers deux belles régions camerounaises : nos rites coutumiers traditionnels à Baham et nos vœux de mariage civil et religieux à Nkongsamba.',
    ...
    formLabelRelationship: "Lien avec De l'Ange & Joverlin",
    formLabelCardDesign: 'Choisir le Thème Design de la Carte',
    formLabelBlessing: 'Votre Bénédiction ou Prière de Mariage *',
    formPlaceholderBlessing: "Écrivez vos prières, conseils ou félicitations chaleureuses pour De l'Ange et Joverlin à l'occasion de cette union sacrée...",
    ...
    formSuccessDesc: "Merci infiniment ! Votre promesse de cadeau et votre carte de bénédiction ont été enregistrées avec succès pour De l'Ange & Joverlin.",
    ...
    faqHeadingDesc: 'Vous préparez votre voyage à Baham et Nkongsamba ? Nous avons rassemblé les conseils essentiels concernant le transport, le code vestimentaire, la liste de cadeaux et les cérémonies.',
    faqFlightTitle: 'Vols & Transports',
    faqFlightDesc: "Pour le mariage coutumier traditionnel (Baham) comme pour le mariage civil et religieux (Nkongsamba), atterrissez à l'aéroport international de Douala (DLA), la porte d'entrée la plus proche des deux lieux.",
    faqFlightAirportCode: 'Codes Aéroports : NSI, DLA',
    faqHotelTitle: 'Hôtels Partenaires',
    faqHotelDesc: 'Des tarifs de groupe préférentiels ont été négociés pour vous dans des hôtels premium proches de Baham (Bafoussam/Bandjoun) et de Nkongsamba.',
    ...
    rsvpHeadingDesc: "Merci de nous faire part de votre présence avant le 1er juillet 2026. Votre réponse nous permet d'organiser les banquets gastronomiques et les plans de table à Baham et Nkongsamba.",
    rsvpVenueDotation: '{{Nom du lieu, à confirmer}} • Baham, Région de l\'Ouest, Cameroun',
    rsvpVenueWhite: '{{Église / Salle de réception, à confirmer}}, Nkongsamba, Région du Littoral, Cameroun',
    rsvpCoordinator: 'rsvp@christian-ornella.com • +237 6XX XX XX XX (WhatsApp)',
    rsvpRouteTitle: 'Liaison Baham - Nkongsamba',
    rsvpRouteDesc: 'Les deux célébrations ont lieu à une semaine d\'intervalle dans des régions différentes — les invités présents aux deux sont libres d\'organiser leur trajet entre Baham et Nkongsamba via Douala à leur rythme.',
    ...
    footerDesc: 'Nous sommes infiniment bénis de vivre cette merveilleuse aventure réunissant nos familles à Baham et à Nkongsamba. Merci pour vos prières constantes, votre soutien précieux et vos bénédictions.',
